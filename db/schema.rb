...
ActiveRecord::Schema.define(version: 20171030191252) do
  ...
  create_table "guild_events", force: :cascade do |t|
    ...
    t.string "roster"
    t.index ["guild_member_id"], name: "index_guild_events_on_guild_member_id"
  end
  ...
  create_table "guild_members", force: :cascade do |t|
    ...
    t.index ["confirm_token"], name: "index_guild_members_on_confirm_token"
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.integer "guild_member_id"
    t.boolean "guild_only"
    t.index ["guild_member_id"], name: "index_posts_on_guild_member_id"
  end
